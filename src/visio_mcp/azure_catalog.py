...
RESOURCE_ALIASES: dict[str, str] = {
    ...
    # ── Common AI-generated aliases (natural language → canonical key) ──
    # Compute
    "azure_vm": "virtual_machine",
    "server": "virtual_machine",
    "scale_set": "vm_scale_set",
    "azure_functions": "function_app",
    "functions": "function_app",
    "function": "function_app",
    "webapp": "app_service",
    "web_app": "app_service",
    "app": "app_service",
    "azure_app_service": "app_service",
    "spring": "spring_apps",
    "azure_spring": "spring_apps",
    "azure_spring_apps": "spring_apps",
    "batch": "batch_account",
    "azure_batch": "batch_account",
    "sf": "service_fabric",
    "azure_service_fabric": "service_fabric",
    "openshift": "red_hat_openshift",
    "aro": "red_hat_openshift",
    # Containers
    "container_app": "container_apps",
    "azure_container_apps": "container_apps",
    "kubernetes": "kubernetes_service",
    "k8s": "kubernetes_service",
    "azure_kubernetes": "kubernetes_service",
    "azure_kubernetes_service": "kubernetes_service",
    "registry": "container_registry",
    "azure_container_registry": "container_registry",
    "azure_container_instances": "container_instances",
    # Networking
    "network": "virtual_network",
    "azure_vnet": "virtual_network",
    ...
    "lb": "load_balancer",
    "alb": "load_balancer",
    "azure_load_balancer": "load_balancer",
    "app_gateway": "application_gateway",
    "azure_application_gateway": "application_gateway",
    "frontdoor": "front_door",
    "azure_front_door": "front_door",
    "tm": "traffic_manager",
    "azure_traffic_manager": "traffic_manager",
    "dns": "dns_zone",
    "azure_dns": "dns_zone",
    "pe": "private_endpoint",
    "azure_private_endpoint": "private_endpoint",
    "vpn": "vpn_gateway",
    "azure_vpn": "vpn_gateway",
    "azure_vpn_gateway": "vpn_gateway",
    "er": "expressroute",
    "express_route": "expressroute",
    "azure_expressroute": "expressroute",
    "nat": "nat_gateway",
    "azure_nat_gateway": "nat_gateway",
    "vwan": "virtual_wan",
    "azure_vwan": "virtual_wan",
    "azure_virtual_wan": "virtual_wan",
    "udr": "route_table",
    "route": "route_table",
    "routes": "route_table",
    "azure_route_table": "route_table",
    "fw_policy": "firewall_policy",
    "ipg": "ip_group",
    "watcher": "network_watcher",
    "azure_waf": "web_app_firewall",
    "cdn": "cdn_profile",
    "azure_cdn": "cdn_profile",
    "content_delivery_network": "cdn_profile",
    "ddos": "ddos_protection",
    "azure_ddos": "ddos_protection",
    "azure_ddos_protection": "ddos_protection",
    # Storage
    ...
    "blobs": "blob_storage",
    "adls": "data_lake_storage",
    "datalake": "data_lake_storage",
    "data_lake": "data_lake_storage",
    "azure_data_lake": "data_lake_storage",
    "disk": "managed_disk",
    "azure_disk": "managed_disk",
    "files": "file_share",
    "azure_files": "file_share",
    "netapp": "netapp_files",
    "anf": "netapp_files",
    "azure_netapp": "netapp_files",
    # Databases
    "sql_db": "sql_database",
    "azure_sql_db": "sql_database",
    "azure_sql_database": "sql_database",
    "sql_mi": "sql_managed_instance",
    "managed_instance": "sql_managed_instance",
    "elastic_pool": "sql_elastic_pool",
    "documentdb": "cosmos_db",
    "azure_cosmos": "cosmos_db",
    "azure_cosmos_db": "cosmos_db",
    "azure_redis": "redis_cache",
    "azure_cache": "redis_cache",
    "cache": "redis_cache",
    "oracle": "oracle_database",
    "azure_postgresql": "postgresql_database",
    "pg": "postgresql_database",
    "azure_mysql": "mysql_database",
    # Security & Identity
    "vault": "key_vault",
    "azure_key_vault": "key_vault",
    "azure_openai": "openai_service",
    "azure_open_ai": "openai_service",
    "gpt": "openai_service",
    "defender": "defender_for_cloud",
    "microsoft_defender": "defender_for_cloud",
    "microsoft_defender_for_cloud": "defender_for_cloud",
    "azure_defender": "defender_for_cloud",
    "azure_sentinel": "sentinel",
    "microsoft_sentinel": "sentinel",
    "managed_id": "managed_identity",
    "msi": "managed_identity",
    "azure_managed_identity": "managed_identity",
    "entra": "entra_id",
    "azure_ad": "entra_id",
    "aad": "entra_id",
    "active_directory": "entra_id",
    "azure_active_directory": "entra_id",
    "microsoft_entra": "entra_id",
    "microsoft_entra_id": "entra_id",
    "app_reg": "app_registration",
    # Integration
    "apim_gateway": "api_management",
    "api_gateway": "api_management",
    "azure_api_management": "api_management",
    "logic_apps": "logic_app",
    "azure_logic_app": "logic_app",
    "azure_logic_apps": "logic_app",
    "servicebus": "service_bus",
    "azure_service_bus": "service_bus",
    "eventhub": "event_hub",
    "event_hubs": "event_hub",
    "azure_event_hub": "event_hub",
    "azure_event_hubs": "event_hub",
    "eventgrid": "event_grid",
    "azure_event_grid": "event_grid",
    # AI & ML
    "cognitive_search": "ai_search",
    "search": "ai_search",
    "azure_ai_search": "ai_search",
    "azure_search": "ai_search",
    "search_service": "ai_search",
    "ml": "machine_learning",
    "azure_ml": "machine_learning",
    "azure_machine_learning": "machine_learning",
    "cog_services": "cognitive_services",
    "azure_cognitive_services": "cognitive_services",
    "azure_ai": "cognitive_services",
    "bot": "bot_service",
    "azure_bot": "bot_service",
    "azure_bot_service": "bot_service",
    "azure_ai_studio": "ai_studio",
    # Analytics & Data
    "synapse": "synapse_analytics",
    "azure_synapse": "synapse_analytics",
    "azure_synapse_analytics": "synapse_analytics",
    "azure_data_factory": "data_factory",
    "adb": "databricks",
    "azure_databricks": "databricks",
    "kusto": "data_explorer",
    "azure_data_explorer": "data_explorer",
    "hdi": "hdinsight",
    "azure_hdinsight": "hdinsight",
    "azure_stream_analytics": "stream_analytics",
    "aas": "analysis_services",
    "azure_analysis_services": "analysis_services",
    "power_bi": "power_bi_embedded",
    "powerbi": "power_bi_embedded",
    "pbi": "power_bi_embedded",
    "adla": "data_lake_analytics",
    # Monitoring & Management
    "azure_monitor": "monitor",
    "monitoring": "monitor",
    "oms": "log_analytics",
    "workspace": "log_analytics",
    "azure_log_analytics": "log_analytics",
    "app_insights": "application_insights",
    "azure_application_insights": "application_insights",
    "azure_policy": "policy",
    "policies": "policy",
    "automation": "automation_account",
    "azure_automation": "automation_account",
    "arc": "azure_arc",
    "azure_advisor": "advisor",
    "cost": "cost_management",
    "billing": "cost_management",
    "azure_cost_management": "cost_management",
    "rsv": "recovery_services_vault",
    "backup": "recovery_services_vault",
    "azure_backup": "recovery_services_vault",
    "recovery_vault": "recovery_services_vault",
    "rg": "resource_group",
    "sub": "subscription",
    "mg": "management_group",
    "diagnostics": "diagnostic_setting",
    ...
    "azure_devops": "devops",
    "ado": "devops",
    "azure_dev_ops": "devops",
    "gha": "github_actions",
    "github": "github_actions",
    "alt": "load_testing",
    "azure_load_testing": "load_testing",
    # IoT
    "iothub": "iot_hub",
    "iot": "iot_hub",
    "azure_iot": "iot_hub",
    "azure_iot_hub": "iot_hub",
    "iot_central_app": "iot_central",
    "azure_iot_central": "iot_central",
    "adt": "digital_twins",
    "azure_digital_twins": "digital_twins",
    # Web
    "swa": "static_web_app",
    "static_app": "static_web_app",
    "azure_static_web_app": "static_web_app",
    "azure_signalr": "signalr",
    "signalr_service": "signalr",
    # Governance & Migration
    "azure_purview": "purview",
    "microsoft_purview": "purview",
    "azure_migrate": "migrate",
    "azure_chaos_studio": "chaos_studio",
    # Fabric
    "fabric": "fabric_lakehouse",
    "microsoft_fabric": "fabric_lakehouse",
}
